...
public class AssigneeService implements IAssigneeService {
    ...
    public AssigneeResponse create(AssigneeRequest assigneeRequest) {
        ...
        if(Objects.nonNull(user.getEmail()))
            emailHelper.sendEmail(user.getEmail(), "You're assigned in a new project. "+project.getName()+". we wish the best energy your projects and new goals", "New project: " + project.getName(), LocalDateTime.now())    ;
